...
export default function Search() {
    ...
    return (
        ...
        <div
            ...
            <label className="h-[43px] rounded-full bg-[color:var(--background-secondary)] w-full block border border-transparent relative group flex items-center focus-within:bg-[color:var(--background-primary)] focus-within:border-[#1d9bf0]">
