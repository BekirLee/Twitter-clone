    ...
    return (
        <Popover className="box-shadow-[ rgba(0, 0, 0, 0.15) 0px 2px 8px] relative text-[color:var(--color-base)]">
            ...
            <Popover.Button className='py-1 group'>
                ...
                <div className="flex items-center items-center rounded-full py-3 pl-2 relative group-hover:bg-[color:var(--background-secondary)]">
                ...
                <Disclosure>
                    {({ open }) => (
                        <>
                            ...
                            <Disclosure.Panel className=" px-4 pb-3" onClick={() => setModal('appearance')}>
