...
export default function More() {
    ...
    return (
        <div >
                ...
                accounts.map((account, index) => (
                    <button key={index}
                        ...
                        <div className="userInfo flex flex-col items-center  pl-3">
                            <div className="userName text-left w-full">
                                {account.userName}
                            </div>
                            <div className="userMail opacity-40 text-sm w-full text-[color:var(--base-secondary)]">
                                @{account.fullName}
                            </div>
                        </div>
                        {
                            currentAccount.id === account.id && (
                                <svg className="w-[20px] h-[20px] ml-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <button className="py-3 px-4 text-left transition-colors hover:bg-[color:var(--background-secondary)] w-full font-bold">
                add new account
            </button>
