export default function Post({ post }) {
    return (
        <div className="border-b border-[color:var(--background-third)] flex gap-3 py-3 px-4 relative before:absolute before:inset-0 before: z-[-1] before:transiton-colors before:hover:bg-[color:var(--background-secondary)]">
